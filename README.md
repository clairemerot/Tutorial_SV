...
We will do easy plotting of genome synteny with dotplots using a stan web application called D-Genies.
...
Next, we will obtain nice ribbon plots with the R package SVbyEye .
